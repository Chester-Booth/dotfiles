...
Column {
    ...
    Item {
        ...
        height: (config.InputFontSize != "" ? config.InputFontSize * 2 : root.font.pointSize * 2)
        ...
        Label {
            ...
            font.pointSize: (config.InputFontSize != "" ? config.InputFontSize * 0.8 : root.font.pointSize * 0.8)
            font.italic: true
    ...
    Item {
        ...
        height: (config.InputFontSize != "" ? config.InputFontSize * 4.5 : root.font.pointSize * 4.5)
        width: parent.width / 2
        anchors.horizontalCenter: parent.horizontalCenter
        ...
        ComboBox {
            ...
            delegate: ItemDelegate {
                ...
                contentItem: Text {
                    ...
                    font.family: config.InputFont != "" ? config.InputFont : root.font.family
        ...
        TextField {
            ...
            height: (config.InputFontSize != "" ? config.InputFontSize * 3 : root.font.pointSize * 3)
            width: parent.width
            ...
            font.family: config.InputFont != "" ? config.InputFont : root.font.family
            font.pointSize: config.InputFontSize != "" ? config.InputFontSize : root.font.pointSize
            font.bold: true
    ...
    Item {
        ...
        TextField {
            ...
            font.family: config.InputFont != "" ? config.InputFont : root.font.family
            font.pointSize: config.InputFontSize != "" ? config.InputFontSize : root.font.pointSize *3
            font.bold: true
    ...
    Item {
        ...
        // important
        // try 4 or 9 ...
        height: (config.InputFontSize != "" ? config.InputFontSize * 4 : root.font.pointSize * 4)
        width: parent.width / 2
        anchors.horizontalCenter: parent.horizontalCenter
