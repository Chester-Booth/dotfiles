...
# OPTIMIZED FOR LOW OVERHEAD - Direct sysfs reads, minimal external calls
...
# === CPU CLOCK (average of online cores) ===
total=0
count=0
...
# === POWER DRAW (battery only - lightweight) ===
