# Generated by Powerlevel10k configuration wizard on 2026-01-08 at 16:45 GMT.
...
# light-ornaments, compact, few icons, concise, transient_prompt,
...
() {
  ...
  local is_vscode_terminal=false
  [[ $TERM_PROGRAM == vscode || -n $VSCODE_INJECTION ]] && is_vscode_terminal=true
