...
ColumnLayout {
    ...
    Clock {
        ...
        // important
        Layout.preferredHeight: root.height / (config.LoginFormClockHeight != "" ? config.LoginFormClockHeight : 3)
    ...
    Input {
        ...
        Layout.preferredHeight: root.height / (config.LoginFormInputHeight != "" ? config.LoginFormInputHeight : 10)
        Layout.leftMargin: p != "0" ? a == "left" ? -p : a == "right" ? p : 0 : 0
        Layout.topMargin:  0
    }
